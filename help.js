...
window.HELP_SECTIONS = [
    ...
    { cat: "KLIKASZ W KRAJ", items: [
        ...
        { icon: "🫥", text: "Jeśli przy jakimś kraju brakuje przycisku, który widzisz gdzie indziej — to celowe, nie usterka. Ukrywamy te, które prowadziłyby donikąd: dla bezludnych terytoriów i najmniejszych wysepek serwisy zewnętrzne po prostu nie mają danych. Lepiej, żeby przycisku nie było, niż żeby otwierał pustą stronę." },
