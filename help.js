...
window.HELP_SECTIONS = [
    ...
    { cat: "KLIKASZ W KRAJ", items: [
        ...
        { icon: "🚇", text: "Miasta z metrem albo koleją miejską mają dodatkowo przycisk „METRO” — schematyczna mapa sieci z serwisu UrbanRail. Nie każde miasto go ma: przycisk pojawia się tylko tam, gdzie taka sieć istnieje (na dziś 514 miast w bazie)." },
