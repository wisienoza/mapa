...
window.HELP_SECTIONS = [
    ...
    { cat: "KLIKASZ W KRAJ", items: [
        ...
        { icon: "🚆", text: "Na dole profilu kraju jest pasek przycisków otwieranych w nowej karcie (mapy, zdjęcia, kuchnia, koszty życia, święta, szczepienia i inne). Dla krajów z sensowną siecią kolejową dochodzi tu przycisk „POCIĄGI” — przewodnik, jak podróżować po danym kraju pociągiem. Nie każdy kraj go ma." },
    ...
    { cat: "TWÓJ POSTĘP", items: [
        ...
        { icon: "⭐", text: "Lista Cudów Świata — kliknij dowolny, żeby zobaczyć jego zdjęcie, opis i przenieść się do niego na mapie. W profilu cudu też jest wiersz „ODWIEDZONE” oraz przyciski: Wikivoyage (praktyczny przewodnik — dojazd, bilety, godziny), Wikipedia i zdjęcia. Wikivoyage opisuje miejsca, a nie same zabytki, więc przy części cudów trafisz na artykuł miasta lub dzielnicy, w której leżą — tam są konkretne informacje dla podróżnego." },
