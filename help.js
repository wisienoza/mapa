...
window.HELP_SECTIONS = [
    ...
    { cat: "KLIKASZ W KRAJ", items: [
        ...
        { icon: "🚆", text: "Na dole profilu kraju jest pasek przycisków otwieranych w nowej karcie (mapy, zdjęcia, kuchnia, koszty życia, święta i inne). Dla krajów z sensowną siecią kolejową dochodzi tu przycisk „POCIĄGI” — przewodnik, jak podróżować po danym kraju pociągiem. Nie każdy kraj go ma. Jest tam też „UNESCO” — profil kraju na stronie UNESCO z listą obiektów światowego dziedzictwa; UNESCO prowadzi je dla państw członkowskich, więc przy większości terytoriów zależnych (Grenlandia, Portoryko, Hongkong, Gibraltar…) tego przycisku nie zobaczysz." },
