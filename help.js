...
window.HELP_SECTIONS = [
    ...
    { cat: "KLIKASZ W KRAJ", items: [
        ...
        { icon: "📖", text: "Kliknięcie lotniska pokazuje jego profil po prawej: miasto, kraj i wiersz „RUCH” z klasą lotniska. Pod spodem są linki — Wikipedia (po polsku, a gdzie polskiego artykułu nie ma, po angielsku) plus strony o noclegu na lotnisku, poidełkach i palarniach. Przycisku, dla którego nie ma czego otworzyć, po prostu nie zobaczysz — nie ma martwych linków." },
