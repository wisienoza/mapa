...
window.HELP_SECTIONS = [
    ...
    { cat: "KLIKASZ W KRAJ", items: [
        ...
        { icon: "🚆", text: "Na dole profilu kraju jest pasek przycisków otwieranych w nowej karcie (mapy, zdjęcia, kuchnia, koszty życia, święta, szczepienia i inne). Dla krajów z sensowną siecią kolejową dochodzi tu przycisk „POCIĄGI” — przewodnik, jak podróżować po danym kraju pociągiem. Nie każdy kraj go ma. Jest tam też „UNESCO” — profil kraju na stronie UNESCO z listą obiektów światowego dziedzictwa." },
        ...
        { icon: "🚄", text: "Profil miasta ma na dole zestaw przycisków otwieranych w nowej karcie: przewodniki i mapy, a także planer trasy z Warszawy (Rome2Rio) i wyszukiwarkę noclegów (Booking). Rome2Rio nie pokazuje się dla samej Warszawy. Oba te przyciski pytają o miasto razem z krajem, więc trafiają we właściwe miejsce nawet przy nazwach, które powtarzają się na świecie — Valencia w Wenezueli nie zaprowadzi Cię do Hiszpanii." },
        { icon: "🚇", text: "Miasta z metrem albo koleją miejską mają dodatkowo przycisk „METRO” — schematyczna mapa sieci z serwisu UrbanRail. Nie każde miasto go ma: przycisk pojawia się tylko tam, gdzie taka sieć istnieje (na dziś 473 miasta w bazie)." },
