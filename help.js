...
window.HELP_SECTIONS = [
    ...
    { cat: "TWÓJ POSTĘP", items: [
        ...
        { icon: "🗂️", text: "Na górze panelu odznak jest spis treści — kafelek każdej kategorii z licznikiem zaliczonych (zielony, gdy masz komplet). Kliknij, żeby przeskoczyć do tej sekcji. Nagłówki kategorii trzymają się górnej krawędzi przy przewijaniu, więc zawsze wiadomo, gdzie jesteś." },
        { icon: "💎", text: "Każda odznaka ma poziom trudności: brąz, srebro, złoto, platyna, diament. Widać go po kolorze tła kafelka i po znaczku w prawym górnym rogu — im wyższy poziom, tym bardziej rozbudowany kształt (od prostego szewronu do kryształu). Platynowe i diamentowe odznaki dodatkowo świecą. Poziom liczy się z progu odznaki porównanego z innymi w tej samej kategorii, więc „złoto” w LOTACH i „złoto” w MIASTACH znaczą podobny wysiłek, mimo że jedno mierzy kilometry, a drugie miasta. Odznaka jeszcze niezdobyta jest szara — kolor pojawia się dopiero, gdy ją zaliczysz. Kliknięcie w nazwę Twojej rangi (lewy górny róg) otwiera paszport operatora: ranga, zasięg podboju, drabinka poziomów odznak, najrzadsze zdobycze i podsumowanie nalotu. Kliknięcie w pasek dowolnego poziomu w paszporcie pokazuje wszystkie odznaki tylko z tego poziomu." },
