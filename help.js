...
window.HELP_SECTIONS = [
    ...
    { cat: "KLIKASZ W KRAJ", items: [
        ...
        { icon: "🔗", text: "Wiele wierszy w profilu to klikalne skróty na zewnątrz — kurs waluty, języki (z nagraniami, jak brzmią), hymn narodowy do odsłuchania, porada bezpieczeństwa, woda z kranu, wtyczki elektryczne czy święta państwowe. Każdy otwiera odpowiednią stronę w nowej karcie." },
