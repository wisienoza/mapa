...
window.HELP_SECTIONS = [
    ...
    { cat: "KLIKASZ W KRAJ", items: [
        ...
        { icon: "🔗", text: "Wiele wierszy w profilu to klikalne skróty na zewnątrz — kurs waluty, języki (z nagraniami, jak brzmią), hymn narodowy do odsłuchania, porada bezpieczeństwa, woda z kranu, wtyczki elektryczne, napiwki, odległość od Warszawy (planer trasy do stolicy) czy święta państwowe. Każdy otwiera odpowiednią stronę w nowej karcie." },
        { icon: "🏛️", text: "Wiersz „CAPITAL” to wyjątek — nie prowadzi na zewnątrz, tylko otwiera profil miasta-stolicy (populacja, zdjęcie, pogoda, klimat), zostając przy tym samym kraju na globusie." },
