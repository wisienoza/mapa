...
window.HELP_SECTIONS = [
    ...
    { cat: "KLIKASZ W KRAJ", items: [
        ...
        { icon: "📉", text: "Wiersz „KOSZTY” ma 540 miast w 121 krajach i przy pozostałych po prostu nie występuje. Powód nie leży po naszej stronie: Numbeo publikuje porównywalny indeks tylko dla miast, w których zebrał dość ankiet — na dziś 561 na cały świat. Dlatego mnożnika nie ma ani Luanda, ani La Paz, ani Gaborone czy Nassau, mimo że są stolicami. Zamiast pokazywać liczbę wziętą z sufitu, wiersz znika." },
