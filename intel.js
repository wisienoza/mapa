...
const INTEL_DB = {
    ...
    "NI": { p: "120V [ADAPTER: TAK]", w: "⚠️ RACZEJ BUTELKA", t: "10%" },
    ...
    "GO": { p: "230V [ADAPTER: NIE]", w: "⚠️ DESZCZÓWKA", t: "Baza FR (Wojsko)" }, // Wyspy Glorioso (Îles Éparses, dystrykt TAAF)
    "JU": { p: "230V [ADAPTER: NIE]", w: "⚠️ DESZCZÓWKA", t: "Baza FR (Wojsko)" }, // Juan de Nova (Îles Éparses, dystrykt TAAF)
...
const CAPITAL_COORDS = {
	...
	"GO": [-11.57, 47.29],  // Grande Glorieuse (Wyspy Glorioso) - dopisane 2026-07-27
	"JU": [-17.05, 42.73],  // Juan de Nova - dopisane 2026-07-27
	// UWAGA: te terytoria (UM/TF/HM/BV/GO/JU/AQ) NIE MAJA stolicy (FACTBOOK.capital jest puste -> wiersz
...
"UM-WQ": [19.30, 166.63],  // Wake Island
    ...
    "BV": "Brak (Lód)", // Bouvet
    "GO": "Brak (Żółwie)", // Wyspy Glorioso - rezerwat, garnizon FR
    "JU": "Brak (Garnizon)", // Juan de Nova - garnizon FR
...
const COST_INDEX = {
    ...
    "TF": "N/A", "HM": "N/A", "BV": "N/A", "AQ": "N/A", "GS": "N/A", "IO": "N/A", "GO": "N/A", "JU": "N/A",
...
// GO + JU dopisane 2026-07-27: to jedyne dwa poligony geodaty, ktore nie mialy ZADNEGO wpisu w
// slownikach (byly klikalne i bezimienne, a jako "sieroty" wpadaly do obejscia renderOrphanNotice
// w admin.php). Wyspy Glorioso i Juan de Nova to francuskie Iles Eparses - w ISO 3166-1 nalezace
// do TF, ale amCharts (za Natural Earth) rysuje je jako osobne obiekty z kodami GO/JU.
const EXCLUDED_CODES = ["GL", "PR", "GF", "RE", "PF", "GP", "MQ", "NC", "KY", "BM", "FK", "PS", "EH", "FO", "GI", "IM", "JE", "GG", "AX", "SJ", "AW", "CW", "SX", "BQ", "BL", "MF", "PM", "AI", "VG", "VI", "TC", "MS", "SH", "GS", "YT", "IO", "MO", "HK", "GU", "MP", "AS", "CK", "NU", "TK", "WF", "NF", "PN", "CX", "CC", "TF", "HM", "BV", "GO", "JU", "AQ", "PL", "UM", "UM-DQ", "UM-FQ", "UM-HQ", "UM-JQ", "UM-KQ", "UM-MQ", "UM-NQ", "UM-PQ", "UM-WQ"];
...
// GOV_LINKS - oficjalna KRAJOWA strona rzadowa panstwa. iso2 -> PELNY URL (na sztywno, jak RAIL_LINKS/DIAL_LINKS).
// Zrodlo: baza UN e-Government (publicadministration.un.org/egovkb/en-us/Resources/Country-URLs), zaciagnieta
// 2026-07-23. Uzywane w naglowku panelu intel (app.js, updateFactbookPanel): klik w "nazwa · KOD" prowadzi na te
...
const GOV_LINKS = {
    ...
    "BD":"http://www.bangladesh.gov.bd", "BE":"http://www.belgium.be", "BF":"http://www.gouvernement.gov.bf",
    "BG":"https://egov.bg", "BH":"https://www.bahrain.bh", "BI":"http://www.burundi.gov.bi",
    "BJ":"https://gouv.bj/", "BN":"https://www.gov.bn/SitePages/Home.aspx", "BO":"https://www.gob.bo/",
    "BR":"http://www.brazil.gov.br", "BS":"http://www.bahamas.gov.bs", "BT":"http://www.bhutan.gov.bt",
    "BW":"http://www.gov.bw", "BY":"https://portal.gov.by", "BZ":"https://www.belize.gov.bz/",
    "CA":"https://www.canada.ca/", "CD":"http://www.presidentrdc.cd", "CF":"https://www.gouv.cf/",
    "CG":"https://presidence.cg/", "CH":"http://www.admin.ch", "CI":"http://www.gouv.ci",
    "CL":"http://www.gob.cl", "CM":"http://www.spm.gov.cm", "CN":"http://www.gov.cn",
    "CO":"https://www.gov.co/", "CR":"https://presidencia.go.cr", "CU":"http://www.cuba.cu",
    "CV":"https://www.governo.cv", "CY":"http://www.cyprus.gov.cy", "CZ":"http://www.vlada.cz",
    "DE":"http://www.bundesregierung.de", "DJ":"http://www.presidence.dj", "DK":"https://www.regeringen.dk",
    "DM":"http://www.dominica.gov.dm", "DO":"http://dominicana.gob.do", "DZ":"http://www.el-mouradia.dz",
    "EC":"https://www.presidencia.gob.ec/", "EE":"https://www.valitsus.ee", "EG":"http://www.egypt.gov.org",
    "ER":"http://www.shabait.com", "ES":"https://administracion.gob.es", "ET":"https://www.pmo.gov.et/",
    "FI":"https://www.suomi.fi", "FJ":"http://www.fiji.gov.fj", "FM":"http://www.fsmgov.org",
    "FR":"http://www.gouvernement.fr", "GA":"http://www.gouvernement.ga", "GB":"https://www.gov.uk",
    "GD":"http://www.gov.gd", "GE":"http://gov.ge", "GH":"http://www.ghana.gov.gh",
    "GM":"http://www.statehouse.gm", "GN":"http://www.gouvernement.gov.gn", "GQ":"http://www.guineaecuatorialpress.com",
    "GR":"https://www.government.gov.gr/", "GT":"http://www.presidencia.gob.gt", "GW":"http://www.gov.gw",
    "GY":"https://parliament.gov.gy/", "HN":"http://www.presidencia.gob.hn/", "HR":"http://www.vlada.hr/",
    "HT":"http://primature.gouv.ht", "HU":"http://www.magyarorszag.hu", "ID":"https://indonesia.go.id/",
    "IE":"http://www.gov.ie", "IL":"http://www.gov.il", "IN":"https://www.india.gov.in/",
    "IQ":"http://www.cabinet.iq", "IR":"https://president.ir/en", "IS":"http://www.government.is",
    "IT":"http://www.governo.it", "JM":"http://jis.gov.jm", "JO":"https://jordan.gov.jo",
    "JP":"https://www.e-gov.go.jp/", "KE":"http://www.mygov.go.ke", "KG":"http://www.gov.kg",
    "KH":"http://www.cdc-crdb.gov.kh", "KI":"http://www.president.gov.ki", "KM":"https://beit-salam.km/",
    "KN":"https://www.gov.kn", "KP":"http://korea-dpr.com", "KR":"https://www.gov.kr",
    "KW":"https://e.gov.kw/", "KZ":"http://www.government.kz/", "LA":"https://www.tourismlaos.org/",
    "LB":"http://www.dawlati.gov.lb", "LC":"http://www.govt.lc", "LI":"http://regierung.li", "LK":"http://www.gov.lk", "LR":"http://www.eliberia.gov.lr",
    "LS":"https://www.gov.ls/", "LT":"https://lrv.lt", "LU":"http://www.gouvernement.lu",
    "LV":"http://www.latvija.lv", "LY":"http://www.pm.gov.ly", "MA":"https://maroc.ma/en",
    "MC":"http://www.gouv.mc/", "MD":"http://www.gov.md", "ME":"http://www.gov.me",
    "MG":"http://www.presidence.gov.mg", "MH":"http://www.rmiembassyus.org", "MK":"http://www.vlada.mk",
    "ML":"https://primature.ml/", "MM":"https://www.myanmar.gov.mm/", "MN":"http://zasag.mn",
    "MR":"http://primature.gov.mr", "MT":"http://www.gov.mt", "MU":"http://www.govmu.org/",
    "MV":"https://citizen.egov.mv", "MW":"http://www.malawi.gov.mw/", "MX":"http://www.gob.mx",
    "MY":"http://www.malaysia.gov.my", "MZ":"https://portaldogoverno.gov.mz/", "NA":"http://www.gov.na",
    "NE":"http://www.gouv.ne", "NG":"https://nigeria.gov.ng/", "NI":"https://www.asamblea.gob.ni",
    ...
    "PA":"http://www.presidencia.gob.pa", "PE":"http://www.peru.gob.pe", "PG":"https://papuanewguinea.travel/",
    ...
    "SC":"http://www.egov.sc", "SD":"https://sudan.gov.sd/", "SE":"http://www.regeringen.se",
    "SG":"http://www.gov.sg", "SI":"http://www.vlada.si", "SK":"http://www.slovensko.sk",
    "SL":"https://statehouse.gov.sl/", "SM":"http://www.sanmarino.sm", "SN":"https://www.sec.gouv.sn",
    "SO":"https://opm.gov.so", "SR":"http://www.gov.sr", "SS":"http://www.goss-online.org",
    "ST":"http://www.parlamento.st", "SV":"https://www.asamblea.gob.sv", "SY":"http://www.egov.sy",
    "SZ":"http://www.gov.sz/", "TD":"https://presidence.td/", "TG":"https://www.republicoftogo.com/",
    "TH":"http://www.thaigov.go.th", "TJ":"http://www.president.tj", "TL":"http://timor-leste.gov.tl",
    "TM":"http://www.turkmenistan.gov.tm", "TN":"http://www.tunisie.gov.tn", "TO":"http://www.tongaportal.gov.to",
...
// WORLDOMETER_LINKS - strona populacji kraju na worldometers.info: iso2 -> PELNY URL (na sztywno). Licznik ludnosci
// na zywo + gestosc, mediana wieku, urbanizacja, dzietnosc, udzial w populacji swiata. Zrodlo slugow: strona-indeks
// worldometers.info/world-population/population-by-country/ (linki = kanoniczne adresy), zaciag 2026-07-23. Uzywane
// w wierszu POPULATION panelu intel (app.js, updateFactbookPanel) przez _extVal (strzalka "↗"); brak wpisu = sama
// liczba bez linku. Sluginy nieregularne, dlatego PELNY URL, nie generujemy: US->us, GB->uk, CI->cote-d-ivoire,
// CD->democratic-republic-of-the-congo, CZ->czechia, SZ->swaziland, HK->china-hong-kong-sar, MO->china-macao-sar,
// BN->brunei-darussalam, FO->faeroe-islands, FK->falkland-islands-malvinas... Klucz cca2 (jak FACTBOOK); nazwy UN
// dopasowane do iso2 przez mledoze/countries. ~234 wpisy (kraje + terytoria zamorskie).
const WORLDOMETER_LINKS = {
    "AD":"https://www.worldometers.info/world-population/andorra-population/", "AE":"https://www.worldometers.info/world-population/united-arab-emirates-population/",
    "AF":"https://www.worldometers.info/world-population/afghanistan-population/", "AG":"https://www.worldometers.info/world-population/antigua-and-barbuda-population/",
    "AI":"https://www.worldometers.info/world-population/anguilla-population/", "AL":"https://www.worldometers.info/world-population/albania-population/",
    "AM":"https://www.worldometers.info/world-population/armenia-population/", "AO":"https://www.worldometers.info/world-population/angola-population/",
    "AR":"https://www.worldometers.info/world-population/argentina-population/", "AS":"https://www.worldometers.info/world-population/american-samoa-population/",
    "AT":"https://www.worldometers.info/world-population/austria-population/", "AU":"https://www.worldometers.info/world-population/australia-population/",
    "AW":"https://www.worldometers.info/world-population/aruba-population/", "AZ":"https://www.worldometers.info/world-population/azerbaijan-population/",
    "BA":"https://www.worldometers.info/world-population/bosnia-and-herzegovina-population/", "BB":"https://www.worldometers.info/world-population/barbados-population/",
    "BD":"https://www.worldometers.info/world-population/bangladesh-population/", "BE":"https://www.worldometers.info/world-population/belgium-population/",
    "BF":"https://www.worldometers.info/world-population/burkina-faso-population/", "BG":"https://www.worldometers.info/world-population/bulgaria-population/",
    "BH":"https://www.worldometers.info/world-population/bahrain-population/", "BI":"https://www.worldometers.info/world-population/burundi-population/",
    "BJ":"https://www.worldometers.info/world-population/benin-population/", "BL":"https://www.worldometers.info/world-population/saint-barthelemy-population/",
    "BM":"https://www.worldometers.info/world-population/bermuda-population/", "BN":"https://www.worldometers.info/world-population/brunei-darussalam-population/",
    "BO":"https://www.worldometers.info/world-population/bolivia-population/", "BQ":"https://www.worldometers.info/world-population/caribbean-netherlands-population/",
    "BR":"https://www.worldometers.info/world-population/brazil-population/", "BS":"https://www.worldometers.info/world-population/bahamas-population/",
    "BT":"https://www.worldometers.info/world-population/bhutan-population/", "BW":"https://www.worldometers.info/world-population/botswana-population/",
    "BY":"https://www.worldometers.info/world-population/belarus-population/", "BZ":"https://www.worldometers.info/world-population/belize-population/",
    "CA":"https://www.worldometers.info/world-population/canada-population/", "CD":"https://www.worldometers.info/world-population/democratic-republic-of-the-congo-population/",
    "CF":"https://www.worldometers.info/world-population/central-african-republic-population/", "CG":"https://www.worldometers.info/world-population/congo-population/",
    "CH":"https://www.worldometers.info/world-population/switzerland-population/", "CI":"https://www.worldometers.info/world-population/cote-d-ivoire-population/",
    "CK":"https://www.worldometers.info/world-population/cook-islands-population/", "CL":"https://www.worldometers.info/world-population/chile-population/",
    "CM":"https://www.worldometers.info/world-population/cameroon-population/", "CN":"https://www.worldometers.info/world-population/china-population/",
    "CO":"https://www.worldometers.info/world-population/colombia-population/", "CR":"https://www.worldometers.info/world-population/costa-rica-population/",
    "CU":"https://www.worldometers.info/world-population/cuba-population/", "CV":"https://www.worldometers.info/world-population/cabo-verde-population/",
    "CW":"https://www.worldometers.info/world-population/curacao-population/", "CY":"https://www.worldometers.info/world-population/cyprus-population/",
    "CZ":"https://www.worldometers.info/world-population/czechia-population/", "DE":"https://www.worldometers.info/world-population/germany-population/",
    "DJ":"https://www.worldometers.info/world-population/djibouti-population/", "DK":"https://www.worldometers.info/world-population/denmark-population/",
    "DM":"https://www.worldometers.info/world-population/dominica-population/", "DO":"https://www.worldometers.info/world-population/dominican-republic-population/",
    "DZ":"https://www.worldometers.info/world-population/algeria-population/", "EC":"https://www.worldometers.info/world-population/ecuador-population/",
    "EE":"https://www.worldometers.info/world-population/estonia-population/", "EG":"https://www.worldometers.info/world-population/egypt-population/",
    "EH":"https://www.worldometers.info/world-population/western-sahara-population/", "ER":"https://www.worldometers.info/world-population/eritrea-population/",
    "ES":"https://www.worldometers.info/world-population/spain-population/", "ET":"https://www.worldometers.info/world-population/ethiopia-population/",
    "FI":"https://www.worldometers.info/world-population/finland-population/", "FJ":"https://www.worldometers.info/world-population/fiji-population/",
    "FK":"https://www.worldometers.info/world-population/falkland-islands-malvinas-population/", "FM":"https://www.worldometers.info/world-population/micronesia-population/",
    "FO":"https://www.worldometers.info/world-population/faeroe-islands-population/", "FR":"https://www.worldometers.info/world-population/france-population/",
    "GA":"https://www.worldometers.info/world-population/gabon-population/", "GB":"https://www.worldometers.info/world-population/uk-population/",
    "GD":"https://www.worldometers.info/world-population/grenada-population/", "GE":"https://www.worldometers.info/world-population/georgia-population/",
    "GF":"https://www.worldometers.info/world-population/french-guiana-population/", "GH":"https://www.worldometers.info/world-population/ghana-population/",
    "GI":"https://www.worldometers.info/world-population/gibraltar-population/", "GL":"https://www.worldometers.info/world-population/greenland-population/",
    "GM":"https://www.worldometers.info/world-population/gambia-population/", "GN":"https://www.worldometers.info/world-population/guinea-population/",
    "GP":"https://www.worldometers.info/world-population/guadeloupe-population/", "GQ":"https://www.worldometers.info/world-population/equatorial-guinea-population/",
    "GR":"https://www.worldometers.info/world-population/greece-population/", "GT":"https://www.worldometers.info/world-population/guatemala-population/",
    "GU":"https://www.worldometers.info/world-population/guam-population/", "GW":"https://www.worldometers.info/world-population/guinea-bissau-population/",
    "GY":"https://www.worldometers.info/world-population/guyana-population/", "HK":"https://www.worldometers.info/world-population/china-hong-kong-sar-population/",
    "HN":"https://www.worldometers.info/world-population/honduras-population/", "HR":"https://www.worldometers.info/world-population/croatia-population/",
    "HT":"https://www.worldometers.info/world-population/haiti-population/", "HU":"https://www.worldometers.info/world-population/hungary-population/",
    "ID":"https://www.worldometers.info/world-population/indonesia-population/", "IE":"https://www.worldometers.info/world-population/ireland-population/",
    "IL":"https://www.worldometers.info/world-population/israel-population/", "IM":"https://www.worldometers.info/world-population/isle-of-man-population/",
    "IN":"https://www.worldometers.info/world-population/india-population/", "IQ":"https://www.worldometers.info/world-population/iraq-population/",
    "IR":"https://www.worldometers.info/world-population/iran-population/", "IS":"https://www.worldometers.info/world-population/iceland-population/",
    "IT":"https://www.worldometers.info/world-population/italy-population/", "JM":"https://www.worldometers.info/world-population/jamaica-population/",
    "JO":"https://www.worldometers.info/world-population/jordan-population/", "JP":"https://www.worldometers.info/world-population/japan-population/",
    "KE":"https://www.worldometers.info/world-population/kenya-population/", "KG":"https://www.worldometers.info/world-population/kyrgyzstan-population/",
    "KH":"https://www.worldometers.info/world-population/cambodia-population/", "KI":"https://www.worldometers.info/world-population/kiribati-population/",
    "KM":"https://www.worldometers.info/world-population/comoros-population/", "KN":"https://www.worldometers.info/world-population/saint-kitts-and-nevis-population/",
    "KP":"https://www.worldometers.info/world-population/north-korea-population/", "KR":"https://www.worldometers.info/world-population/south-korea-population/",
    "KW":"https://www.worldometers.info/world-population/kuwait-population/", "KY":"https://www.worldometers.info/world-population/cayman-islands-population/",
    "KZ":"https://www.worldometers.info/world-population/kazakhstan-population/", "LA":"https://www.worldometers.info/world-population/laos-population/",
    "LB":"https://www.worldometers.info/world-population/lebanon-population/", "LC":"https://www.worldometers.info/world-population/saint-lucia-population/",
    "LI":"https://www.worldometers.info/world-population/liechtenstein-population/", "LK":"https://www.worldometers.info/world-population/sri-lanka-population/",
    "LR":"https://www.worldometers.info/world-population/liberia-population/", "LS":"https://www.worldometers.info/world-population/lesotho-population/",
    "LT":"https://www.worldometers.info/world-population/lithuania-population/", "LU":"https://www.worldometers.info/world-population/luxembourg-population/",
    "LV":"https://www.worldometers.info/world-population/latvia-population/", "LY":"https://www.worldometers.info/world-population/libya-population/",
    "MA":"https://www.worldometers.info/world-population/morocco-population/", "MC":"https://www.worldometers.info/world-population/monaco-population/",
    "MD":"https://www.worldometers.info/world-population/moldova-population/", "ME":"https://www.worldometers.info/world-population/montenegro-population/",
    "MF":"https://www.worldometers.info/world-population/saint-martin-population/", "MG":"https://www.worldometers.info/world-population/madagascar-population/",
    "MH":"https://www.worldometers.info/world-population/marshall-islands-population/", "MK":"https://www.worldometers.info/world-population/north-macedonia-population/",
    "ML":"https://www.worldometers.info/world-population/mali-population/", "MM":"https://www.worldometers.info/world-population/myanmar-population/",
    "MN":"https://www.worldometers.info/world-population/mongolia-population/", "MO":"https://www.worldometers.info/world-population/china-macao-sar-population/",
    "MP":"https://www.worldometers.info/world-population/northern-mariana-islands-population/", "MQ":"https://www.worldometers.info/world-population/martinique-population/",
    "MR":"https://www.worldometers.info/world-population/mauritania-population/", "MS":"https://www.worldometers.info/world-population/montserrat-population/",
    "MT":"https://www.worldometers.info/world-population/malta-population/", "MU":"https://www.worldometers.info/world-population/mauritius-population/",
    "MV":"https://www.worldometers.info/world-population/maldives-population/", "MW":"https://www.worldometers.info/world-population/malawi-population/",
    "MX":"https://www.worldometers.info/world-population/mexico-population/", "MY":"https://www.worldometers.info/world-population/malaysia-population/",
    "MZ":"https://www.worldometers.info/world-population/mozambique-population/", "NA":"https://www.worldometers.info/world-population/namibia-population/",
    "NC":"https://www.worldometers.info/world-population/new-caledonia-population/", "NE":"https://www.worldometers.info/world-population/niger-population/",
    "NG":"https://www.worldometers.info/world-population/nigeria-population/", "NI":"https://www.worldometers.info/world-population/nicaragua-population/",
    "NL":"https://www.worldometers.info/world-population/netherlands-population/", "NO":"https://www.worldometers.info/world-population/norway-population/",
    "NP":"https://www.worldometers.info/world-population/nepal-population/", "NR":"https://www.worldometers.info/world-population/nauru-population/",
    "NU":"https://www.worldometers.info/world-population/niue-population/", "NZ":"https://www.worldometers.info/world-population/new-zealand-population/",
    "OM":"https://www.worldometers.info/world-population/oman-population/", "PA":"https://www.worldometers.info/world-population/panama-population/",
    "PE":"https://www.worldometers.info/world-population/peru-population/", "PF":"https://www.worldometers.info/world-population/french-polynesia-population/",
    "PG":"https://www.worldometers.info/world-population/papua-new-guinea-population/", "PH":"https://www.worldometers.info/world-population/philippines-population/",
    "PK":"https://www.worldometers.info/world-population/pakistan-population/", "PL":"https://www.worldometers.info/world-population/poland-population/",
    "PM":"https://www.worldometers.info/world-population/saint-pierre-and-miquelon-population/", "PR":"https://www.worldometers.info/world-population/puerto-rico-population/",
    "PS":"https://www.worldometers.info/world-population/state-of-palestine-population/", "PT":"https://www.worldometers.info/world-population/portugal-population/",
    "PW":"https://www.worldometers.info/world-population/palau-population/", "PY":"https://www.worldometers.info/world-population/paraguay-population/",
    "QA":"https://www.worldometers.info/world-population/qatar-population/", "RE":"https://www.worldometers.info/world-population/reunion-population/",
    "RO":"https://www.worldometers.info/world-population/romania-population/", "RS":"https://www.worldometers.info/world-population/serbia-population/",
    "RU":"https://www.worldometers.info/world-population/russia-population/", "RW":"https://www.worldometers.info/world-population/rwanda-population/",
    "SA":"https://www.worldometers.info/world-population/saudi-arabia-population/", "SB":"https://www.worldometers.info/world-population/solomon-islands-population/",
    "SC":"https://www.worldometers.info/world-population/seychelles-population/", "SD":"https://www.worldometers.info/world-population/sudan-population/",
    "SE":"https://www.worldometers.info/world-population/sweden-population/", "SG":"https://www.worldometers.info/world-population/singapore-population/",
    "SH":"https://www.worldometers.info/world-population/saint-helena-population/", "SI":"https://www.worldometers.info/world-population/slovenia-population/",
    "SK":"https://www.worldometers.info/world-population/slovakia-population/", "SL":"https://www.worldometers.info/world-population/sierra-leone-population/",
    "SM":"https://www.worldometers.info/world-population/san-marino-population/", "SN":"https://www.worldometers.info/world-population/senegal-population/",
    "SO":"https://www.worldometers.info/world-population/somalia-population/", "SR":"https://www.worldometers.info/world-population/suriname-population/",
    "SS":"https://www.worldometers.info/world-population/south-sudan-population/", "ST":"https://www.worldometers.info/world-population/sao-tome-and-principe-population/",
    "SV":"https://www.worldometers.info/world-population/el-salvador-population/", "SX":"https://www.worldometers.info/world-population/sint-maarten-population/",
    "SY":"https://www.worldometers.info/world-population/syria-population/", "SZ":"https://www.worldometers.info/world-population/swaziland-population/",
    "TC":"https://www.worldometers.info/world-population/turks-and-caicos-islands-population/", "TD":"https://www.worldometers.info/world-population/chad-population/",
    "TG":"https://www.worldometers.info/world-population/togo-population/", "TH":"https://www.worldometers.info/world-population/thailand-population/",
    "TJ":"https://www.worldometers.info/world-population/tajikistan-population/", "TK":"https://www.worldometers.info/world-population/tokelau-population/",
    "TL":"https://www.worldometers.info/world-population/timor-leste-population/", "TM":"https://www.worldometers.info/world-population/turkmenistan-population/",
    "TN":"https://www.worldometers.info/world-population/tunisia-population/", "TO":"https://www.worldometers.info/world-population/tonga-population/",
    "TR":"https://www.worldometers.info/world-population/turkey-population/", "TT":"https://www.worldometers.info/world-population/trinidad-and-tobago-population/",
    "TV":"https://www.worldometers.info/world-population/tuvalu-population/", "TW":"https://www.worldometers.info/world-population/taiwan-population/",
    "TZ":"https://www.worldometers.info/world-population/tanzania-population/", "UA":"https://www.worldometers.info/world-population/ukraine-population/",
    "UG":"https://www.worldometers.info/world-population/uganda-population/", "US":"https://www.worldometers.info/world-population/us-population/",
    "UY":"https://www.worldometers.info/world-population/uruguay-population/", "UZ":"https://www.worldometers.info/world-population/uzbekistan-population/",
    "VA":"https://www.worldometers.info/world-population/holy-see-population/", "VC":"https://www.worldometers.info/world-population/saint-vincent-and-the-grenadines-population/",
    "VE":"https://www.worldometers.info/world-population/venezuela-population/", "VG":"https://www.worldometers.info/world-population/british-virgin-islands-population/",
    "VI":"https://www.worldometers.info/world-population/united-states-virgin-islands-population/", "VN":"https://www.worldometers.info/world-population/vietnam-population/",
    "VU":"https://www.worldometers.info/world-population/vanuatu-population/", "WF":"https://www.worldometers.info/world-population/wallis-and-futuna-islands-population/",
    "WS":"https://www.worldometers.info/world-population/samoa-population/", "YE":"https://www.worldometers.info/world-population/yemen-population/",
    "YT":"https://www.worldometers.info/world-population/mayotte-population/", "ZA":"https://www.worldometers.info/world-population/south-africa-population/",
    "ZM":"https://www.worldometers.info/world-population/zambia-population/", "ZW":"https://www.worldometers.info/world-population/zimbabwe-population/",
};
...
// ============================================================================
// === WIKIPEDIA (dopisane 2026-07-27) ===
// ============================================================================
// Przycisk 📖 WIKIPEDIA w links-grid profilu kraju. id -> PELNY URL. Domyslnie pl.wikipedia;
// gdy polskiego hasla nie ma, wpis wskazuje en.wikipedia i app.js dokleja do etykiety " (EN)".
// Brak wpisu = brak przycisku.
//
// DLACZEGO SLOWNIK, A NIE SLUG SKLEJANY Z NAZWY: polskie tytuly czesto nie sa rowne nazwie kraju
// ("Wybrzeze Kosci Sloniowej", "Demokratyczna Republika Konga"), a COUNTRY_NAMES_PL trzyma nazwy
// WYSWIETLANE, nie tytuly hasel - np. MM to tam "Mjanma (Birma)", a haslo nazywa sie "Mjanma".
//
// ZBUDOWANE Z API MEDIAWIKI (partiami po 10, bo prop=coordinates ma limit 10 na zapytanie -
// wiekszy batch po cichu obcina wyniki; ta sama pulapka co przy WONDER_WV i CITIES_DB).
// Zrodlo tytulow: COUNTRY_NAMES_PL, z redirects=1, wiec zapisany jest CEL przekierowania.
// Wynik: 250 hasel polskich + 2 angielskie (GO, JU, MM->fallback nadpisany recznie).
//
// >>> KONTROLA WSPOLRZEDNYMI ZLAPALA 6 ZLYCH TRAFIEN - RUB TO SAMO PRZY KAZDYM NOWYM WPISIE.
// Sam test "czy haslo istnieje" przepuscil je wszystkie (HTTP 200, strona istnieje), a filtr
// pageprops.disambiguation TEZ ich nie zlapal - to strony-listy bez szablonu ujednoznaczniajacego.
// Wylapal je dopiero BRAK WSPOLRZEDNYCH w artykule:
//   "Kajmany"      -> m.in. PODRODZINA GADOW z rodziny aligatorowatych  => Kajmany (wyspy)
//   "Norfolk"      -> hrabstwo w Anglii / miasto w Kanadzie / baza US Navy => Norfolk (terytorium)
//   "Tajwan"       -> wyspa / panstwo / dwie rozne prowincje            => Republika Chinska
//   "Sint Maarten" -> cala wyspa / holenderska polowa                   => Sint Maarten (terytorium)
//   "Palestyna"    -> REGION GEOGRAFICZNY, nie panstwo                  => Palestyna (panstwo)
//   "Mjanma (Birma)" -> tytul nie istnieje (to nazwa wyswietlana)       => Mjanma
// BRAK WSPOLRZEDNYCH W HASLE TO SYGNAL OSTRZEGAWCZY, NIE DROBIAZG.
// Duzy rozjazd wspolrzednych (CA 1616 km, MY 1140, PF 1086, RU 956) jest OK - to panstwa wielkie
// albo rozrzucone po oceanie, gdzie "srodek" z FACTBOOK i z hasla po prostu sie roznia.
const WIKI_LINKS = {
    "AD": "https://pl.wikipedia.org/wiki/Andora",
    "AE": "https://pl.wikipedia.org/wiki/Zjednoczone_Emiraty_Arabskie",
    "AF": "https://pl.wikipedia.org/wiki/Afganistan",
    "AG": "https://pl.wikipedia.org/wiki/Antigua_i_Barbuda",
    "AI": "https://pl.wikipedia.org/wiki/Anguilla",
    "AL": "https://pl.wikipedia.org/wiki/Albania",
    "AM": "https://pl.wikipedia.org/wiki/Armenia",
    "AO": "https://pl.wikipedia.org/wiki/Angola",
    "AQ": "https://pl.wikipedia.org/wiki/Antarktyda",
    "AR": "https://pl.wikipedia.org/wiki/Argentyna",
    "AS": "https://pl.wikipedia.org/wiki/Samoa_Amerykańskie",
    "AT": "https://pl.wikipedia.org/wiki/Austria",
    "AU": "https://pl.wikipedia.org/wiki/Australia",
    "AW": "https://pl.wikipedia.org/wiki/Aruba",
    "AX": "https://pl.wikipedia.org/wiki/Wyspy_Alandzkie",
    "AZ": "https://pl.wikipedia.org/wiki/Azerbejdżan",
    "BA": "https://pl.wikipedia.org/wiki/Bośnia_i_Hercegowina",
    "BB": "https://pl.wikipedia.org/wiki/Barbados",
    "BD": "https://pl.wikipedia.org/wiki/Bangladesz",
    "BE": "https://pl.wikipedia.org/wiki/Belgia",
    "BF": "https://pl.wikipedia.org/wiki/Burkina_Faso",
    "BG": "https://pl.wikipedia.org/wiki/Bułgaria",
    "BH": "https://pl.wikipedia.org/wiki/Bahrajn",
    "BI": "https://pl.wikipedia.org/wiki/Burundi",
    "BJ": "https://pl.wikipedia.org/wiki/Benin",
    "BL": "https://pl.wikipedia.org/wiki/Saint-Barthélemy",
    "BM": "https://pl.wikipedia.org/wiki/Bermudy",
    "BN": "https://pl.wikipedia.org/wiki/Brunei",
    "BO": "https://pl.wikipedia.org/wiki/Boliwia",
    "BQ": "https://pl.wikipedia.org/wiki/Antyle_Holenderskie",
    "BR": "https://pl.wikipedia.org/wiki/Brazylia",
    "BS": "https://pl.wikipedia.org/wiki/Bahamy",
    "BT": "https://pl.wikipedia.org/wiki/Bhutan",
    "BV": "https://pl.wikipedia.org/wiki/Wyspa_Bouveta",
    "BW": "https://pl.wikipedia.org/wiki/Botswana",
    "BY": "https://pl.wikipedia.org/wiki/Białoruś",
    "BZ": "https://pl.wikipedia.org/wiki/Belize",
    "CA": "https://pl.wikipedia.org/wiki/Kanada",
    "CC": "https://pl.wikipedia.org/wiki/Wyspy_Kokosowe",
    "CD": "https://pl.wikipedia.org/wiki/Demokratyczna_Republika_Konga",
    "CF": "https://pl.wikipedia.org/wiki/Republika_Środkowoafrykańska",
    "CG": "https://pl.wikipedia.org/wiki/Kongo",
    "CH": "https://pl.wikipedia.org/wiki/Szwajcaria",
    "CI": "https://pl.wikipedia.org/wiki/Wybrzeże_Kości_Słoniowej",
    "CK": "https://pl.wikipedia.org/wiki/Wyspy_Cooka",
    "CL": "https://pl.wikipedia.org/wiki/Chile",
    "CM": "https://pl.wikipedia.org/wiki/Kamerun",
    "CN": "https://pl.wikipedia.org/wiki/Chińska_Republika_Ludowa",
    "CO": "https://pl.wikipedia.org/wiki/Kolumbia",
    "CR": "https://pl.wikipedia.org/wiki/Kostaryka",
    "CU": "https://pl.wikipedia.org/wiki/Kuba",
    "CV": "https://pl.wikipedia.org/wiki/Republika_Zielonego_Przylądka",
    "CW": "https://pl.wikipedia.org/wiki/Curaçao",
    "CX": "https://pl.wikipedia.org/wiki/Wyspa_Bożego_Narodzenia",
    "CY": "https://pl.wikipedia.org/wiki/Cypr",
    "CZ": "https://pl.wikipedia.org/wiki/Czechy",
    "DE": "https://pl.wikipedia.org/wiki/Niemcy",
    "DJ": "https://pl.wikipedia.org/wiki/Dżibuti",
    "DK": "https://pl.wikipedia.org/wiki/Dania",
    "DM": "https://pl.wikipedia.org/wiki/Dominika",
    "DO": "https://pl.wikipedia.org/wiki/Dominikana",
    "DZ": "https://pl.wikipedia.org/wiki/Algieria",
    "EC": "https://pl.wikipedia.org/wiki/Ekwador",
    "EE": "https://pl.wikipedia.org/wiki/Estonia",
    "EG": "https://pl.wikipedia.org/wiki/Egipt",
    "EH": "https://pl.wikipedia.org/wiki/Sahara_Zachodnia",
    "ER": "https://pl.wikipedia.org/wiki/Erytrea",
    "ES": "https://pl.wikipedia.org/wiki/Hiszpania",
    "ET": "https://pl.wikipedia.org/wiki/Etiopia",
    "FI": "https://pl.wikipedia.org/wiki/Finlandia",
    "FJ": "https://pl.wikipedia.org/wiki/Fidżi",
    "FK": "https://pl.wikipedia.org/wiki/Falklandy",
    "FM": "https://pl.wikipedia.org/wiki/Mikronezja",
    "FO": "https://pl.wikipedia.org/wiki/Wyspy_Owcze",
    "FR": "https://pl.wikipedia.org/wiki/Francja",
    "GA": "https://pl.wikipedia.org/wiki/Gabon",
    "GB": "https://pl.wikipedia.org/wiki/Wielka_Brytania",
    "GD": "https://pl.wikipedia.org/wiki/Grenada",
    "GE": "https://pl.wikipedia.org/wiki/Gruzja",
    "GF": "https://pl.wikipedia.org/wiki/Gujana_Francuska",
    "GG": "https://pl.wikipedia.org/wiki/Guernsey",
    "GH": "https://pl.wikipedia.org/wiki/Ghana",
    "GI": "https://pl.wikipedia.org/wiki/Gibraltar",
    "GL": "https://pl.wikipedia.org/wiki/Grenlandia",
    "GM": "https://pl.wikipedia.org/wiki/Gambia",
    "GN": "https://pl.wikipedia.org/wiki/Gwinea",
    "GO": "https://en.wikipedia.org/wiki/Glorioso_Islands",
    "GP": "https://pl.wikipedia.org/wiki/Gwadelupa",
    "GQ": "https://pl.wikipedia.org/wiki/Gwinea_Równikowa",
    "GR": "https://pl.wikipedia.org/wiki/Grecja",
    "GS": "https://pl.wikipedia.org/wiki/Georgia_Południowa_i_Sandwich_Południowy",
    "GT": "https://pl.wikipedia.org/wiki/Gwatemala",
    "GU": "https://pl.wikipedia.org/wiki/Guam",
    "GW": "https://pl.wikipedia.org/wiki/Gwinea_Bissau",
    "GY": "https://pl.wikipedia.org/wiki/Gujana",
    "HK": "https://pl.wikipedia.org/wiki/Hongkong",
    "HM": "https://pl.wikipedia.org/wiki/Wyspy_Heard_i_McDonalda",
    "HN": "https://pl.wikipedia.org/wiki/Honduras",
    "HR": "https://pl.wikipedia.org/wiki/Chorwacja",
    "HT": "https://pl.wikipedia.org/wiki/Haiti",
    "HU": "https://pl.wikipedia.org/wiki/Węgry",
    "ID": "https://pl.wikipedia.org/wiki/Indonezja",
    "IE": "https://pl.wikipedia.org/wiki/Irlandia",
    "IL": "https://pl.wikipedia.org/wiki/Izrael",
    "IM": "https://pl.wikipedia.org/wiki/Wyspa_Man",
    "IN": "https://pl.wikipedia.org/wiki/Indie",
    "IO": "https://pl.wikipedia.org/wiki/Brytyjskie_Terytorium_Oceanu_Indyjskiego",
    "IQ": "https://pl.wikipedia.org/wiki/Irak",
    "IR": "https://pl.wikipedia.org/wiki/Iran",
    "IS": "https://pl.wikipedia.org/wiki/Islandia",
    "IT": "https://pl.wikipedia.org/wiki/Włochy",
    "JE": "https://pl.wikipedia.org/wiki/Jersey",
    "JM": "https://pl.wikipedia.org/wiki/Jamajka",
    "JO": "https://pl.wikipedia.org/wiki/Jordania",
    "JP": "https://pl.wikipedia.org/wiki/Japonia",
    "JU": "https://en.wikipedia.org/wiki/Juan_de_Nova_Island",
    "KE": "https://pl.wikipedia.org/wiki/Kenia",
    "KG": "https://pl.wikipedia.org/wiki/Kirgistan",
    "KH": "https://pl.wikipedia.org/wiki/Kambodża",
    "KI": "https://pl.wikipedia.org/wiki/Kiribati",
    "KM": "https://pl.wikipedia.org/wiki/Komory",
    "KN": "https://pl.wikipedia.org/wiki/Saint_Kitts_i_Nevis",
    "KP": "https://pl.wikipedia.org/wiki/Korea_Północna",
    "KR": "https://pl.wikipedia.org/wiki/Korea_Południowa",
    "KW": "https://pl.wikipedia.org/wiki/Kuwejt",
    "KY": "https://pl.wikipedia.org/wiki/Kajmany_(wyspy)",
    "KZ": "https://pl.wikipedia.org/wiki/Kazachstan",
    "LA": "https://pl.wikipedia.org/wiki/Laos",
    "LB": "https://pl.wikipedia.org/wiki/Liban",
    "LC": "https://pl.wikipedia.org/wiki/Saint_Lucia",
    "LI": "https://pl.wikipedia.org/wiki/Liechtenstein",
    "LK": "https://pl.wikipedia.org/wiki/Sri_Lanka",
    "LR": "https://pl.wikipedia.org/wiki/Liberia",
    "LS": "https://pl.wikipedia.org/wiki/Lesotho",
    "LT": "https://pl.wikipedia.org/wiki/Litwa",
    "LU": "https://pl.wikipedia.org/wiki/Luksemburg",
    "LV": "https://pl.wikipedia.org/wiki/Łotwa",
    "LY": "https://pl.wikipedia.org/wiki/Libia",
    "MA": "https://pl.wikipedia.org/wiki/Maroko",
    "MC": "https://pl.wikipedia.org/wiki/Monako",
    "MD": "https://pl.wikipedia.org/wiki/Mołdawia",
    "ME": "https://pl.wikipedia.org/wiki/Czarnogóra",
    "MF": "https://pl.wikipedia.org/wiki/Saint-Martin",
    "MG": "https://pl.wikipedia.org/wiki/Madagaskar",
    "MH": "https://pl.wikipedia.org/wiki/Wyspy_Marshalla",
    "MK": "https://pl.wikipedia.org/wiki/Macedonia_Północna",
    "ML": "https://pl.wikipedia.org/wiki/Mali",
    "MM": "https://pl.wikipedia.org/wiki/Mjanma",
    "MN": "https://pl.wikipedia.org/wiki/Mongolia",
    "MO": "https://pl.wikipedia.org/wiki/Makau",
    "MP": "https://pl.wikipedia.org/wiki/Mariany_Północne",
    "MQ": "https://pl.wikipedia.org/wiki/Martynika",
    "MR": "https://pl.wikipedia.org/wiki/Mauretania",
    "MS": "https://pl.wikipedia.org/wiki/Montserrat",
    "MT": "https://pl.wikipedia.org/wiki/Malta",
    "MU": "https://pl.wikipedia.org/wiki/Mauritius",
    "MV": "https://pl.wikipedia.org/wiki/Malediwy",
    "MW": "https://pl.wikipedia.org/wiki/Malawi",
    "MX": "https://pl.wikipedia.org/wiki/Meksyk",
    "MY": "https://pl.wikipedia.org/wiki/Malezja",
    "MZ": "https://pl.wikipedia.org/wiki/Mozambik",
    "NA": "https://pl.wikipedia.org/wiki/Namibia",
    "NC": "https://pl.wikipedia.org/wiki/Nowa_Kaledonia",
    "NE": "https://pl.wikipedia.org/wiki/Niger",
    "NF": "https://pl.wikipedia.org/wiki/Norfolk_(terytorium)",
    "NG": "https://pl.wikipedia.org/wiki/Nigeria",
    "NI": "https://pl.wikipedia.org/wiki/Nikaragua",
    "NL": "https://pl.wikipedia.org/wiki/Holandia",
    "NO": "https://pl.wikipedia.org/wiki/Norwegia",
    "NP": "https://pl.wikipedia.org/wiki/Nepal",
    "NR": "https://pl.wikipedia.org/wiki/Nauru",
    "NU": "https://pl.wikipedia.org/wiki/Niue",
    "NZ": "https://pl.wikipedia.org/wiki/Nowa_Zelandia",
    "OM": "https://pl.wikipedia.org/wiki/Oman",
    "PA": "https://pl.wikipedia.org/wiki/Panama",
    "PE": "https://pl.wikipedia.org/wiki/Peru",
    "PF": "https://pl.wikipedia.org/wiki/Polinezja_Francuska",
    "PG": "https://pl.wikipedia.org/wiki/Papua-Nowa_Gwinea",
    "PH": "https://pl.wikipedia.org/wiki/Filipiny",
    "PK": "https://pl.wikipedia.org/wiki/Pakistan",
    "PL": "https://pl.wikipedia.org/wiki/Polska",
    "PM": "https://pl.wikipedia.org/wiki/Saint-Pierre_i_Miquelon",
    "PN": "https://pl.wikipedia.org/wiki/Pitcairn",
    "PR": "https://pl.wikipedia.org/wiki/Portoryko",
    "PS": "https://pl.wikipedia.org/wiki/Palestyna_(państwo)",
    "PT": "https://pl.wikipedia.org/wiki/Portugalia",
    "PW": "https://pl.wikipedia.org/wiki/Palau",
    "PY": "https://pl.wikipedia.org/wiki/Paragwaj",
    "QA": "https://pl.wikipedia.org/wiki/Katar",
    "RE": "https://pl.wikipedia.org/wiki/Reunion",
    "RO": "https://pl.wikipedia.org/wiki/Rumunia",
    "RS": "https://pl.wikipedia.org/wiki/Serbia",
    "RU": "https://pl.wikipedia.org/wiki/Rosja",
    "RW": "https://pl.wikipedia.org/wiki/Rwanda",
    "SA": "https://pl.wikipedia.org/wiki/Arabia_Saudyjska",
    "SB": "https://pl.wikipedia.org/wiki/Wyspy_Salomona",
    "SC": "https://pl.wikipedia.org/wiki/Seszele",
    "SD": "https://pl.wikipedia.org/wiki/Sudan",
    "SE": "https://pl.wikipedia.org/wiki/Szwecja",
    "SG": "https://pl.wikipedia.org/wiki/Singapur",
    "SH": "https://pl.wikipedia.org/wiki/Wyspa_Świętej_Heleny",
    "SI": "https://pl.wikipedia.org/wiki/Słowenia",
    "SJ": "https://pl.wikipedia.org/wiki/Svalbard_i_Jan_Mayen",
    "SK": "https://pl.wikipedia.org/wiki/Słowacja",
    "SL": "https://pl.wikipedia.org/wiki/Sierra_Leone",
    "SM": "https://pl.wikipedia.org/wiki/San_Marino",
    "SN": "https://pl.wikipedia.org/wiki/Senegal",
    "SO": "https://pl.wikipedia.org/wiki/Somalia",
    "SR": "https://pl.wikipedia.org/wiki/Surinam",
    "SS": "https://pl.wikipedia.org/wiki/Sudan_Południowy",
    "ST": "https://pl.wikipedia.org/wiki/Wyspy_Świętego_Tomasza_i_Książęca",
    "SV": "https://pl.wikipedia.org/wiki/Salwador",
    "SX": "https://pl.wikipedia.org/wiki/Sint_Maarten_(terytorium)",
    "SY": "https://pl.wikipedia.org/wiki/Syria",
    "SZ": "https://pl.wikipedia.org/wiki/Eswatini",
    "TC": "https://pl.wikipedia.org/wiki/Turks_i_Caicos",
    "TD": "https://pl.wikipedia.org/wiki/Czad",
    "TF": "https://pl.wikipedia.org/wiki/Francuskie_Terytoria_Południowe_i_Antarktyczne",
    "TG": "https://pl.wikipedia.org/wiki/Togo",
    "TH": "https://pl.wikipedia.org/wiki/Tajlandia",
    "TJ": "https://pl.wikipedia.org/wiki/Tadżykistan",
    "TK": "https://pl.wikipedia.org/wiki/Tokelau",
    "TL": "https://pl.wikipedia.org/wiki/Timor_Wschodni",
    "TM": "https://pl.wikipedia.org/wiki/Turkmenistan",
    "TN": "https://pl.wikipedia.org/wiki/Tunezja",
    "TO": "https://pl.wikipedia.org/wiki/Tonga",
    "TR": "https://pl.wikipedia.org/wiki/Turcja",
    "TT": "https://pl.wikipedia.org/wiki/Trynidad_i_Tobago",
    "TV": "https://pl.wikipedia.org/wiki/Tuvalu",
    "TW": "https://pl.wikipedia.org/wiki/Republika_Chińska",
    "TZ": "https://pl.wikipedia.org/wiki/Tanzania",
    "UA": "https://pl.wikipedia.org/wiki/Ukraina",
    "UG": "https://pl.wikipedia.org/wiki/Uganda",
    "UM": "https://pl.wikipedia.org/wiki/Dalekie_Wyspy_Mniejsze_Stanów_Zjednoczonych",
    "US": "https://pl.wikipedia.org/wiki/Stany_Zjednoczone",
    "UY": "https://pl.wikipedia.org/wiki/Urugwaj",
    "UZ": "https://pl.wikipedia.org/wiki/Uzbekistan",
    "VA": "https://pl.wikipedia.org/wiki/Watykan",
    "VC": "https://pl.wikipedia.org/wiki/Saint_Vincent_i_Grenadyny",
    "VE": "https://pl.wikipedia.org/wiki/Wenezuela",
    "VG": "https://pl.wikipedia.org/wiki/Brytyjskie_Wyspy_Dziewicze",
    "VI": "https://pl.wikipedia.org/wiki/Wyspy_Dziewicze_Stanów_Zjednoczonych",
    "VN": "https://pl.wikipedia.org/wiki/Wietnam",
    "VU": "https://pl.wikipedia.org/wiki/Vanuatu",
    "WF": "https://pl.wikipedia.org/wiki/Wallis_i_Futuna",
    "WS": "https://pl.wikipedia.org/wiki/Samoa",
    "XK": "https://pl.wikipedia.org/wiki/Kosowo",
    "YE": "https://pl.wikipedia.org/wiki/Jemen",
    "YT": "https://pl.wikipedia.org/wiki/Majotta",
    "ZA": "https://pl.wikipedia.org/wiki/Południowa_Afryka",
    "ZM": "https://pl.wikipedia.org/wiki/Zambia",
    "ZW": "https://pl.wikipedia.org/wiki/Zimbabwe"
};
